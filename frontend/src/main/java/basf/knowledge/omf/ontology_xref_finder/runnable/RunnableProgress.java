...
/**
 * RunnableProgress is a Runnable class that is able to execute an AbstractXrefClient
 * and update a JProgressBar while processing the AbstractXrefClient object.
 */
public class RunnableProgress implements Runnable, RunnableProgressPerformer {
	...
	public RunnableProgress(RunnableProgressListener listener, AbstractXrefClient xrefClient, JProgressBar progressBar) {
